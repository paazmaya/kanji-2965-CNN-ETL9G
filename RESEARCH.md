...
3.  **[Hi-GITA (Hierarchical Multi-Granularity Image-Text Aligning)](https://arxiv.org/abs/2505.24837):** This latest approach (May 2025) builds on HierCode by adding multi-level contrastive learning between image and text representations (Zero-Shot Chinese Character Recognition with Hierarchical Multi-Granularity Image-Text Aligning, Zhu, Yu, Wang, Lu, Xue, & Li, 2025).
