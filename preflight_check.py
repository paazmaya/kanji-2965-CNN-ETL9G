...
def check_requirements():
    ...
    required_packages = [
        ...
        'matplotlib', 'tqdm', 'cv2', 'PIL', 'onnx', 'onnxruntime'
    ]
...
def check_system_resources():
    ...
    try:
        ...
        if available_gb < 8:
            print("⚠ Warning: Less than 8 GB RAM available. Consider using --sample-limit for testing.")
        else:
...
def main():
    ...
    if checks_passed == total_checks:
        ...
        print("1. python prepare_etl9g_dataset.py --etl-dir ETL9G --output-dir dataset --size 64")
        print("2. python test_etl9g_setup.py --data-dir dataset --test-model")
        print("3. python train_etl9g_model.py --data-dir dataset --epochs 30 --export-onnx")
    else:
